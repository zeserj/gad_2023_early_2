...
class _$ProductsState$ implements ProductsState$ {
  ...
  @override
  String toString() {
    return 'ProductsState(products: $products, productIds: $productIds, vendors: $vendors, categories: $categories, selectedCategoryId: $selectedCategoryId, selectedProductId: $selectedProductId)';
  }
