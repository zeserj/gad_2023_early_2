...
/// @nodoc
abstract class _$$UpdateCart$CopyWith<$Res> implements $UpdateCartCopyWith<$Res> {
  factory _$$UpdateCart$CopyWith(_$UpdateCart$ value, $Res Function(_$UpdateCart$) then) =
      __$$UpdateCart$CopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String productId, bool add});
}
...
/// @nodoc
class __$$UpdateCart$CopyWithImpl<$Res> extends _$UpdateCartCopyWithImpl<$Res, _$UpdateCart$>
    implements _$$UpdateCart$CopyWith<$Res> {
  __$$UpdateCart$CopyWithImpl(_$UpdateCart$ _value, $Res Function(_$UpdateCart$) _then) : super(_value, _then);
...
class _$UpdateCart$ implements UpdateCart$ {
  const _$UpdateCart$(this.productId, {required this.add});
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateCart$CopyWith<_$UpdateCart$> get copyWith => __$$UpdateCart$CopyWithImpl<_$UpdateCart$>(this, _$identity);
}

abstract class UpdateCart$ implements UpdateCart {
  const factory UpdateCart$(final String productId, {required final bool add}) = _$UpdateCart$;
  ...
  @override
  @JsonKey(ignore: true)
  _$$UpdateCart$CopyWith<_$UpdateCart$> get copyWith => throw _privateConstructorUsedError;
}
